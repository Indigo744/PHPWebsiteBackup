...
//
$_CONFIG['calculate_space_level'] = 10;
...
//
$_CONFIG['main_title'] = "PHP WebSite Backup";
...
// Default: $_CONFIG['allow_wildcards'] = true;
//
$_CONFIG['allow_wildcards'] = true;
...
//
$_CONFIG['hidden_files'] = array("*.php", ".ht*");
...
//
$_CONFIG['users'] = array(
    array("Admin", "5H84BZkw65GuFGw5n59M4P86683p", "admin")
);
...
@media (max-width: 600px) {
    ...
    #upload #password_container, #upload #upload_container, #upload #newdir_container {
        float:none;
        margin-top:5px;
    }
...
if(GateKeeper::isAccessAllowed())
{
	print "<a href='backup.php' target='_blank'>Manual backup</a>\n";
}
?>
<br/>
<span style='font-size:10px'>Based on <a href="http://encode-explorer.siineiolekala.net" target='_blank'>Encode Explorer</a></span>
</div>
<!-- END: Info area -->
</body>
</html>
